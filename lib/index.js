...
module.exports = function preset(context, opts = {}) {
  ...
  const supportVariablesFunctionName = opts.supportVariablesFunctionName !== undefined ? opts.supportVariablesFunctionName : true;
  ...
  return {
    plugins: [
      ...
      edge && supportVariablesFunctionName && require('@babel/plugin-transform-arrow-functions'), // needed for function-name
      edge && supportVariablesFunctionName && require('@babel/plugin-transform-function-name'),
